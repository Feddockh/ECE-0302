...
{
    if (treePtr != 0) { // Enter function if tree node is full, otherwise skip
        visit(treePtr->item); // call the visit function on the tree node's item
        preorder(treePtr->leftChildPtr, visit); // Use recursion to search through the left part of the tree
        preorder(treePtr->rightChildPtr, visit); // Use recursion to search through the right part of the tree
    }
};
...
{
    if (treePtr != 0) {
        inorder(treePtr->leftChildPtr, visit); // Use recursion to search through the left part of the tree
        visit(treePtr->item); // call the visit function on the tree node's item
        inorder(treePtr->rightChildPtr, visit); // Use recursion to search through the right part of the tree
    }
};
...
{
    if (treePtr != 0) {
        postorder(treePtr->leftChildPtr, visit); // Use recursion to search through the left part of the tree
        postorder(treePtr->rightChildPtr, visit); // Use recursion to search through the right part of the tree
        visit(treePtr->item); // call the visit function on the tree node's item
    }
};
